...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    JTextField tfname,tfaddress,tfdate,tfcity,tfstate,tfemail,tfphone;
    JButton next, cancel;
    JLabel lblmeter;
    ...
    JPanel p = new JPanel();
    p.setLayout(null);
    p.setBackground(new Color(173,216,130));
    add(p);
...
lbldate.setBounds(100,240,100,20);
p.add(lbldate)

tfdate = new JTextField();
tfdate.setBounds(240,240,200,20);
p.add(tfdate);*/
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == next) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Meter Information Added Succefully");
                setVisible(false);
